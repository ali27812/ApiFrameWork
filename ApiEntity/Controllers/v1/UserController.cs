...
namespace ApiEntity.Controllers.v1
{
    ...
    public class UserController : BaseController
    {
        ...
        public UserController(IUnitOfWork unitOfWork, IUserRepository userRepository, IJwtService jwtService, ILogger<UserController> logger)
        {
        ...
        public virtual async Task<ActionResult<List<User>>> Get(CancellationToken cancellationToken)
        {
            ...
            var users1 = await _unitOfWork.UserRepository.TableNoTracking.ToListAsync(cancellationToken);
        ...
        [HttpPost]
        [Route("Token")]
        public virtual async Task<ActionResult<string>> Token([FromForm] TokenModel tokenModel, CancellationToken cancellationToken)//TokenModel tokenModel,
        {
